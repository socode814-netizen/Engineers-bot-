...
def handle_all_messages(message):
    ...
    if text == '📊 معدلي الحالي':
        ...
        bot.send_message(chat_id,
            ...
            '✏️ القالب بس لتسهيل الوقت عليك، مو ملزم بحاله: لو عدد وحدات مادة عندك مختلف، عدّليه بنفسك. '
            'ولو ناقصة مادة، ضيفيها بسطر جديد بنفس الشكل (عدد الوحدات + اسم المادة + : + درجتك).\n\n'
            '📌 قالب فصل واحد = معدلك الفصلي لهذا الفصل\n'
            '📌 قوالب أكثر من فصل (من الأول إلى آخر فصل أنهيته) = معدلك التراكمي\n'
            '👇 اختاري قسمك من الأزرار بالأسفل\n\n'
            'للإلغاء أرسل: إلغاء',
...
def show_help(chat_id):
    text = (
        ...
        '🧮 حاسبة المعدل\n'
        'فيها طريقتان:\n'
        '1️⃣ يدوياً: أرسلي كل مادة بسطر لحالها بهذا الشكل: عدد الوحدات ثم الدرجة\n'
        'مثال: 12 BB\n'
        '2️⃣ بالقالب الجاهز (أسهل): اضغطي الزر، واختاري قسمك من الأزرار (عام، مدني، ميكانيكي، كهرباء...)، '
        'بيوصلك قالب كل فصل من فصول تخصصك جاهز بأسماء المواد.\n'
        'انسخي القالب، اكتبي درجتك بعد النقطتين (:) قدام كل مادة أخذتيها، واتركي فاضية (أو احذفي) '
        'أي مادة ما أخذتيها بعد، ثم ارسلي القالب كامل.\n'
        '📌 قالب فصل واحد فقط = معدلك الفصلي لهذا الفصل\n'
        '📌 قوالب أكثر من فصل مع بعض (من الأول لآخر فصل خلصتيه) = معدلك التراكمي\n\n'
        '🎯 كم أحتاج لهدف معين\n'
        'تكتبي معدلك الحالي، والمعدل اللي تبينه، ووحدات فصلك الجاي، ويطلعلك الدرجة اللي لازم تحصلي عليها\n\n'
        '🔄 أثر تحسين مادة\n'
        'تشوفي كيف يتغير معدلك التراكمي لو رفعتي درجة مادة معينة\n\n'
        '🏆 ما تقديري؟\n'
        'تكتبي معدلك ويطلعلك تقديرك الأكاديمي (ممتاز، جيد جداً...)\n\n'
        '⚖️ موازنة مواد فصلي\n'
        'نفس أسلوب حاسبة المعدل (يدوي أو قالب)، لكن توضحلك تأثير كل مادة لحالها على معدلك، '
        'عشان تعرفي وين تركزي مذاكرتك أكثر\n\n'
        '💾 سجل معدلاتي\n'
        'تحفظي معدلك الفصلي أو التراكمي بعد ما تحسبيه، وتتابعي تطورك فصل بعد فصل\n\n'
        '💬 صارحني\n'
        'ابعتي رأيك أو اقتراحك أو مشكلتك للإدارة بأي شكل (نص، صورة، أو تسجيل صوتي)، وهويتك تبقى مجهولة تماماً\n'
        '━━━━━━━━━━━━━━━━━━━━\n'
        '🆘 لو واجهتك أي مشكلة أو ما فهمتِ خطوة، ارسليها في 💬 صارحني وبنساعدك.'
    )
